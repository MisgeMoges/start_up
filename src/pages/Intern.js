            ...
            <div className="card my-4 shadow p-3 mb-5 bg-body-tertiary rounded">
              ...
              <div className="card-body">
                ...
                <p className="card-text">
                  Our team is working to deliver high-quality software products that
                  meet the needs of their clients or users. This requires
                ...
                <a href="/home" className="btn btn-primary d-block text-capitalize">
                  Join Us 
                </a>
              </div>
            </div>
